...
public class BNavigatorActivity extends Activity{
	...
	public void onCreate(Bundle savedInstanceState){
    	...
    	Toast.makeText(BNavigatorActivity.this, BNTTSPlayer.getTTSState()+"", Toast.LENGTH_SHORT).show();
		//设置TTS播放回调
		BNavigatorTTSPlayer.setTTSPlayerListener(new IBNTTSPlayerListener() {
            
            @Override
            public int playTTSText(String arg0, int arg1) {
				mhandHandler.obtainMessage(arg1, arg0).sendToTarget();
            ...
            public void phoneCalling() {
                Toast.makeText(BNavigatorActivity.this, "电话", Toast.LENGTH_SHORT).show();//通话中
            }
...
//                return BNTTSPlayer.getTTSState();
    ...
    Handler mhandHandler = new Handler(){
		...
		public void handleMessage(Message msg) {
			Toast.makeText(BNavigatorActivity.this, msg.obj.toString(), Toast.LENGTH_SHORT).show();
